...
public class ControlDeStockFrame extends JFrame {
	...
	private void modificar() {
		...
		.ifPresentOrElse(fila -> {
			...
			//                    int cantidad = Integer.valueOf(modelo.getValueAt(tabla.getSelectedRow(), 3).toString());

			int cantidadModificada = 0;
			cantidadModificada =  this.productoController.modificar(producto);

			JOptionPane.showMessageDialog(this, cantidadModificada + " Item fue modificado con éxito!");
		}, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
	}
